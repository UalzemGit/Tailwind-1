...
<main>
    <div class="flex flex-col justify-center text-center bg-spotify-theme-mobile md:bg-spotify-theme bg-banner-mobile md:bg-banner bg-195% md:bg-175% bg-purple-main text-green-main py-40 px-4">
        <h1 class="text-5xl md:text-9xl mb-10 font-bold max-w-4xl mx-auto">Escutar muda tudo</h1>
        <p class="text-lg mb-10">Milhões de músicas e podcats para explorar. Enem precisa de cartão de crédito</p>
